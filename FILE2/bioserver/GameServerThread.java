...
class GameServerThread implements Runnable {
    ...
    private final Map readbuffers = new HashMap();
    ...
    public void run() {
        ...
        while (this.initOK) {
          try {
              ...
              Logger.getLogger(GameServerThread.class.getName()).log(Level.WARNING, null, e);
          }
        }
  } 
  
    // closing a connection
    // synchronising this function leads to a deadlock ???
    private void close(SelectionKey key) throws IOException {
        ...
        try {
            ...
            Logging.println("Gameserver Exception on close caught!");
            Logger.getLogger(GameServerThread.class.getName()).log(Level.WARNING, null, e);
        } finally {
            // cleanup
    ...
    private void read(SelectionKey key) throws IOException {
        ...
        try {
            ...
            // also remove this client from list
            Logging.println("Gameserver Exception on read caught!");
            Logger.getLogger(GameServerThread.class.getName()).log(Level.WARNING, null, e);
            this.close(key);
            return;
        }
        ...
        synchronized (this.pendingData) {
            ...
            while (!queue.isEmpty()) {
                ...
                try {
                    ...
                    Logging.println("Gameserver Exception on write caught!");
                    Logger.getLogger(GameServerThread.class.getName()).log(Level.WARNING, null, e);
                    queue.clear();
                    this.close(key);
                    return;
...
//                    System.out.println("ERROR: socket out buf gameserver filled up!");
                    queue.clear();
                    this.close(key);
                    return;
                }
              ...
              if (queue.isEmpty()) {
                  ...
                  // in writing on this socket. Switch back to wait for
                  // data.
